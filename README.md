...
## **Instructions**
To access and utilize the script, open the "" file, which contains the code for my project. To access the dataset, open the "Final project data"  file. 
## **Data**
The data collected for this project was from a list of top 200 songs from the 2010s according to Pitchfork. I analyzed the list by taking note of different characteristics of the songs, including song legnth and popularity through streams on spotify. Each unit of analysis is one song and there are 24 observations. 
## **Operationalization**
